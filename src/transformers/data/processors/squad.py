...
def squad_convert_example_to_features(example, max_seq_length, doc_stride, max_query_length, is_training):
    ...
    sequence_added_tokens = (
        tokenizer.protein_max_len - tokenizer.max_len_single_sentence + 1
        if "roberta" in str(type(tokenizer))
        else tokenizer.protein_max_len - tokenizer.max_len_single_sentence
    )
    sequence_pair_added_tokens = tokenizer.protein_max_len - tokenizer.max_len_sentences_pair

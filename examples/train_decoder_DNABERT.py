...
MODEL_CLASSES = {
    "dna": (BertConfig, BertForGenerate, DNATokenizer),
    "bert": (BertConfig, BertForMaskedLM, BertTokenizer),
    "dna_mlp": (BertConfig, BertForMLPGenerate, DNATokenizer)
}
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if args.local_rank in [-1, 0] and args.logging_steps > 0 and global_step % args.logging_steps == 0:
                    ...
                    tb_writer.add_scalar("train_perplex", torch.exp(torch.tensor((tr_loss - logging_loss) / args.logging_steps)), global_step)
...
def main():
    ...
    # Required parameters
    parser.add_argument(
        "--train_data_file", default="./datasets/CELL_SELEX_2013/Srebf1_TACATT20NCG_Z_4/Srebf1_TACATT20NCG_Z_4_3mers_train.txt",
        type=str, help="The input training data file (a text file)."
    )
    parser.add_argument(
        "--output_dir",
        default="./model_save_path/Srebf1/decoder",
        type=str,
    ...
    parser.add_argument("--learning_rate", default=4e-6, type=float, help="The initial learning rate for Adam.")
    ...
    parser.add_argument(
        "--num_train_epochs", default=10000, type=float, help="Total number of training epochs to perform."
    )
    parser.add_argument(
        "--max_steps",
        default=-1,
    ...
    parser.add_argument("--n_process", type=int, default=128, help="")
